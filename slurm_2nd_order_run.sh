...
python3.9 Second_order_Receptive_field.py --lr "0.01" --momentum "0.5"  --save 1 --experiment 1 --batch_size 128 --use_scheduler 1 --use_scheduler_batch 0 --num_workers 2 --optimiser "ekfac" --record 1 --save_folder "$HOME/deep_small_models_saturation" --grad_clip $7 --record_saturation $8  --epochs $9 -dt $1 --model $2 --RF_level $3 --type $4 --name $5 --input_resolution "${10}"
...
python3.9 Second_order_Receptive_field.py --lr "0.1" --momentum "0.9" --batch_size 128 --use_scheduler 1 --use_scheduler_batch 0 --num_workers 2  --save 1 --experiment 1 --optimiser "sam" --record 1 --save_folder "$HOME/deep_small_models_saturation" --grad_clip $7  --record_saturation $8 --epochs $9 -dt $1 --model $2 --RF_level $3 --type $4 --name $5 --input_resolution "${10}"
  fi
