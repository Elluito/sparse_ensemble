...
python3.9 Second_order_Receptive_field.py --lr "0.01" --momentum "0.5" --grad_clip $7 --save 1 --experiment 1 --record_saturation $8  --epochs 200 --batch_size 128 --use_scheduler 1 --use_scheduler_batch 0 --num_workers 0 --optimiser "ekfac" --record 1 -dt $1 --model $2 --RF_level $3 --type $4 --name $5 --save_folder "$HOME/second_order_experiments"
...
python3.9 Second_order_Receptive_field.py --lr "0.1" --momentum "0.9" --grad_clip $7 --save 1 --experiment 1 --record_saturation $8 --epochs 200 --batch_size 128 --use_scheduler 1 --use_scheduler_batch 0 --num_workers 0 --optimiser "sam" --record 1 -dt $1 --model $2 --RF_level $3 --type $4 --name $5 --save_folder "$HOME/second_order_experiments"
  fi
