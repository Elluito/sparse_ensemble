...
python eval_curve.py --dir=evaluate_curve/cifar10/resnet18/global/fine_tuned --dataset=CIFAR10 --data_path=datasets --transform=ResNet --model=ResNet18 --wd=5e-4 --curve=Bezier --num_bends=3 --ckpt=curves/cifar10/resnet18/global/fine_tuned/checkpoint-200.pt --num_points=60 --use_test