...
#python train.py --dir=curves/cifar10/resnet18/lamp/fine_tuned --dataset=CIFAR10 --use_test --transform=ResNet --data_path=/nobackup/sclaam/data/CIFAR10 --model=ResNet18 --curve=Bezier --num_bends=3 --init_start=/nobackup/sclaam/gradient_flow_data/cifar10/stochastic_LAMP/resnet18/0.9/1676842555.46/weigths/epoch_90.pth --init_end=/nobackup/sclaam/gradient_flow_data/cifar10/deterministic_LAMP/resnet18/0.9//weigths/epoch_90.pth --epochs=200 --lr=0.03 --wd=5e-4 --fix_end --fix_start --num_workers=0
