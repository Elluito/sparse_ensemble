...
qsub -l h_rt=47:00:00 -l coproc_v100=1  -N "extract_features_${model}_${dataset}_rf_level_${rf_level}" slurm_probes_extraction_run.sh "${data_folder}" "${model}" "normal" "${solution}" "${dataset}" "${rf_level}" "${resolution}" "${num_workers}" "${batch_size}" "${save_folder}" "${name}" "${latent_folder}" "${downsampling}"
...
sol1rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731451265.2229764_rf_level_5_sgd_100_res_224_no_ffcv_test_acc_70.3.pth"
sol2rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731451265.2231426_rf_level_6_sgd_100_res_224_no_ffcv_test_acc_68.76.pth"
sol3rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731451265.2230341_rf_level_7_sgd_100_res_224_no_ffcv_test_acc_67.62.pth"
sol4rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731451265.223035_rf_level_8_sgd_100_res_224_no_ffcv_test_acc_67.23.pth"
sol5rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731451265.2231302_rf_level_10_sgd_100_res_224_no_ffcv_test_acc_65.03.pth"
sol6rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731002508.677377_rf_level_11_sgd_100_res_224_no_ffcv_test_acc_44.11.pth"
sol7rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731002507.845115_rf_level_12_sgd_100_res_224_no_ffcv_test_acc_34.88.pth"
sol8rs25="/nobackup/sclaam/resnet25_small_imagenet/resnet25_small_normal_small_imagenet_1731002508.0559256_rf_level_13_sgd_100_res_224_no_ffcv_test_acc_29.1.pth"
...
for ((idxA=0; idxA<levels_max; idxA++));do              # iterate idxB from 0 to length
 run_extraction "${model}" "${dataset}" "${data_folder}" "${solutions[$idxA]}" "${rf_levels[$idxA]}" "${resolution}" 2 128 "${logs_folder}" "${names[$idxA]}" 7 "${latent_folder}"   # "${names[$idxA]}"  "${save_folder}" "50" "0.001" "0"
done
