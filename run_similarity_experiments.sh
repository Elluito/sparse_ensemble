...
#  qsub -l coproc_p100=1 -l h_rt=10:00:00 -N "features_7_seed_${list_to_use_seeds[$idxA]}" run.sh  "resnet50" "${directory}/${list_to_use_files[$idxA]}" "trained_seed_${list_to_use_seeds[$idxA]}_rf_level_7"  "7" "alternative"
  qsub -l coproc_p100=1 -l h_rt=20:00:00 -N "logistic_features_train_4_seed_${list_to_use_seeds[$idxA]}" run.sh  "resnet50" "${directory}/${list_to_use_files[$idxA]}" "trained_seed_${list_to_use_seeds[$idxA]}_rf_level_4"  "4" "alternative" "1"
  qsub -l coproc_p100=1 -l h_rt=20:00:00 -N "logistic_features_test_4_seed_${list_to_use_seeds[$idxA]}" run.sh  "resnet50" "${directory}/${list_to_use_files[$idxA]}" "trained_seed_${list_to_use_seeds[$idxA]}_rf_level_4"  "4" "alternative" "0"
