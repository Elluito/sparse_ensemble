...
qsub -l coproc_v100=1 -l h_rt=00:20:00   -N "${model}_${dataset}_pruning_summary_level_${rf_levels[$idxB]}_${pruning_rates[$idxA]}" run.sh "${model}" "${dataset}" "2" "${rf_levels[$idxa]}" "normal" "${directory}" "${pruning_rates[$idxA]}" "1"
#
