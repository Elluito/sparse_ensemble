...
python Second_order_Receptive_field.py --lr "0.1" --momentum "0.9"  --save 1 --experiment 1 --batch_size 128 --use_scheduler 1 --use_scheduler_batch 0 --num_workers 8 --optimiser "ekfac" --record 1 --save_folder "$SCRASCRATCH/SCRATCH/TCH/second_order_checkpoints" --dataset $1 --model $2 --RF_level $3 --type $4 --name $5 --grad_clip $7 --record_saturation $8  --epochs $9 --input_resolution "${10}"
