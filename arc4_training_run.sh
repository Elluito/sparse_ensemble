...
python3.9 train_CIFAR10.py --ffcv --lr "0.1" --batch_size 128  --save_folder "/nobackup/sclaam/training_models_arc4/" --model $1 --dataset $2 --num_workers $3 --RF_level $4 --type $5 --epochs $6  --name $7 --width $8 --record $9 --input_resolution "${10}"  --ffcv_val "${12}" --ffcv_train "${13}" --record_saturation 0
...
python3.9 train_CIFAR10.py --lr "0.1" --batch_size 128  --save_folder "/nobackup/sclaam/training_models_arc4/" --model $1 --dataset $2 --num_workers $3 --RF_level $4 --type $5 --epochs $6  --name $7 --width $8 --record $9 --input_resolution "${10}" --record_saturation 0
#python3.9 ffcv_loaders.py
