...
def stochastic_pruning_with_static_sigma_and_pr_optimization(cfg: omegaconf.DictConfig):
    ...
    initial_pr_per_layer = prune_with_rate(copy.deepcopy(original_model), target_sparsity, exclude_layers=cfg.exclude_layers, type="layer-wise", pruner="lamp",return_pr_per_layer=True)
