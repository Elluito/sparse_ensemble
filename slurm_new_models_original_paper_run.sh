...
python train_CIFAR10.py --record_time --record_flops --batch_size 128  --save_folder "${SCRATCH}/new_models_original_paper" --model $1 --dataset $2 --num_workers $3 --RF_level $4 --type $5 --epochs $6  --name $7 --width $8 --record $9 --input_resolution "${10}"
