...
run_pruning "resnet_small" "small_imagenet" "/nobackup/sclaam/jade_trained_models" "/nobackup/sclaam/data" "recording_200_no_ffcv" 0 "no_set" "no_set" "${HOME}/sparse_ensemble/confidence_and_RF" 1
