...
sbatch --array=1-4 --nodes=1 --time=140:00:00 --partition=small  --mail-type=all --mail-user=sclaam@leeds.ac.uk --error="task_small_resnet_lv_3_small_imagenet_ffcv.err" --gres=gpu:1 --output="task_small_resnet_lv_3_small_imagenet_ffcv.output"  --job-name="tasksmall_resnet_lv_3_small_imagenet_no_ffcv" slurm_run_ffcv.sh "resnet_small" "small_imagenet" 4 3 "normal" 200 "recording_200_ffcv" 1 1 "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/train_360_0.5_90.ffcv" "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/val_360_0.5_90.ffcv"
