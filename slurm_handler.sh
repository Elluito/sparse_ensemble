...
sbatch --nodes=1 --ntasks-per-node=1 --cpus-per-task=16 --time=140:00:00 --partition=small  --mail-type=all --mail-user=sclaam@leeds.ac.uk --error="dynamic_RF_100_resnet50.err" --gres=gpu:1 --output="dynamic_RF_100_resnet50.output"  --job-name="dynamic_RF_100_resnet50" slurm_run.sh "resnet50" "small_imagenet" 16 7 "normal" 100 "dynamic_RF_100_version_2" 1 1 "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/train_360_0.5_90.ffcv" "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/val_360_0.5_90.ffcv"
sbatch --nodes=1 --ntasks-per-node=1 --cpus-per-task=16 --time=140:00:00 --partition=small  --mail-type=all --mail-user=sclaam@leeds.ac.uk --error="dynamic_RF_100_vgg.err" --gres=gpu:1 --output="dynamic_RF_100_vgg.output"  --job-name="dynamic_RF_100_vgg" slurm_run.sh "vgg19" "small_imagenet" 16 7 "normal" 100 "dynamic_RF_100_version_2" 1 1 "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/train_360_0.5_90.ffcv" "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/val_360_0.5_90.ffcv"
