...
#sbatch --array=1-4 --nodes=1 --time=140:00:00 --partition=small  --mail-type=all --mail-user=sclaam@leeds.ac.uk --error="small_resnet_lv_3_small_imagenet_no_ffcv.err" --gres=gpu:1 --output="small_resnet_lv_3_small_imagenet_no_ffcv.output"  --job-name="small_resnet_lv_3_small_imagenet_no_ffcv" slurm_run.sh "resnet_small" "small_imagenet" 4 3 "normal" 200 "recording_200_no_ffcv" 1 1 "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/train_360_0.5_90.ffcv" "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/val_360_0.5_90.ffcv"
