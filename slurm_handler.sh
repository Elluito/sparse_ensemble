...
#####################################################################################
grad_clip=0.4
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_1_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_1_cifar10_rs_gc_${grad_clip}.output"  --job-name="ekfac_optim_rf_1_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "1" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_2_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_2_cifar10_rs_gc_${grad_clip}.output" --job-name="ekfac_optim_rf_2_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "2" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_3_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_3_cifar10_rs_gc_${grad_clip}.output"  --job-name="ekfac_optim_rf_3_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "3" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_4_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_4_cifar10_rs_gc_${grad_clip}.output" --job-name="ekfac_optim_rf_4_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "4" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_5_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_5_cifar10_rs_gc_${grad_clip}.output" --job-name="ekfac_optim_rf_5_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "5" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_6_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_6_cifar10_rs_gc_${grad_clip}.output" --job-name="ekfac_optim_rf_6_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "6" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_7_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_7_cifar10_rs_gc_${grad_clip}.output" --job-name="ekfac_optim_rf_7_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "7" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="ekfac_optim_rf_8_cifar10_rs_gc_${grad_clip}.err" --output="ekfac_optim_rf_8_cifar10_rs_gc_${grad_clip}.output" --job-name="ekfac_optim_rf_8_cifar10_rs_gc_${grad_clip}" slurm_2nd_order_run.sh "cifar10" "resnet50" "8" "normal" "ekfac_optim_hyper_100_gc_${grad_clip}" "1" grad_clip
##
##
##
##
...
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="sam_optim_rf_k6_cifar10_rs.err" --output="sam_optim_rf_k6_cifar10_rs.output" --job-name="sam_optim_rf_k6_cifar10_rs" slurm_2nd_order_run.sh "cifar10" "resnet50" "k6" "normal" "sam_optim_hyper_200" "2"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="sam_optim_rf_k7_cifar10_rs.err" --output="sam_optim_rf_k7_cifar10_rs.output" --job-name="sam_optim_rf_k7_cifar10_rs" slurm_2nd_order_run.sh "cifar10" "resnet50" "k7" "normal" "sam_optim_hyper_200" "2"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="sam_optim_rf_k8_cifar10_rs.err" --output="sam_optim_rf_k8_cifar10_rs.output" --job-name="sam_optim_rf_k8_cifar10_rs" slurm_2nd_order_run.sh "cifar10" "resnet50" "k8" "normal" "sam_optim_hyper_200" "2"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="sam_optim_rf_k9_cifar10_rs.err" --output="sam_optim_rf_k9_cifar10_rs.output"  --job-name="sam_optim_rf_k9_cifar10_rs" slurm_2nd_order_run.sh "cifar10" "resnet50" "k9" "normal" "sam_optim_hyper_200" "2"
#
...
sbatch --nodes=1 --time=140:00:00 --partition=small  --mail-type=all --mail-user=sclaam@leeds.ac.uk --error="small_resnet_lv_3_small_imagenet_no_ffcv.err" --gres=gpu:1 --output="small_resnet_lv_3_small_imagenet_no_ffcv.output"  --job-name="small_resnet_lv_3_small_imagenet_no_ffcv" slurm_run.sh "resnet_small" "small_imagenet" 4 3 "normal" 200 "no_recording_200_no_ffcv" 1 1 #"/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/train_360_0.5_90.ffcv" "/jmain02/home/J2AD014/mtc03/lla98-mtc03/small_imagenet_ffcv/val_360_0.5_90.ffcv"
