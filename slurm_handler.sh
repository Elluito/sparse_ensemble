...
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="kfac_optim_rf_k6_cifar10_rs.err" --output="kfac_optim_rf_k6_cifar10_rs.output" --job-name="Kfac_optim_rf_k6_cifar10_rs" slurm_2nd_order.sh "cifar10" "resnet50" "5" "normal" "kfac_optim_hyper_100" "1"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="kfac_optim_rf_k7_cifar10_rs.err" --output="kfac_optim_rf_k7_cifar10_rs.output" --job-name="Kfac_optim_rf_k7_cifar10_rs" slurm_2nd_order.sh "cifar10" "resnet50" "6" "normal" "kfac_optim_hyper_100" "1"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="kfac_optim_rf_k8_cifar10_rs.err" --output="kfac_optim_rf_k8_cifar10_rs.output" --job-name="Kfac_optim_rf_k8_cifar10_rs" slurm_2nd_order.sh "cifar10" "resnet50" "7" "normal" "kfac_optim_hyper_100" "1"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="kfac_optim_rf_k9_cifar10_rs.err" --output="kfac_optim_rf_k9_cifar10_rs.output" --job-name="Kfac_optim_rf_k9_cifar10_rs" slurm_2nd_order.sh "cifar10" "resnet50" "8" "normal" "kfac_optim_hyper_100" "1"
##
##
##
##
