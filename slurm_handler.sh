...
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="Kfac_optim_rf_k6_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k6" "normal" "kfac_optim_hyper" "1"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="Kfac_optim_rf_k7_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k7" "normal" "kfac_optim_hyper" "1"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="Kfac_optim_rf_k8_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k8" "normal" "kfac_optim_hyper" "1"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="Kfac_optim_rf_k9_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k9" "normal" "kfac_optim_hyper" "1"
...
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="sam_optim_rf_k6_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k6" "normal" "sam_optim_hyper" "2"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="sam_optim_rf_k7_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k7" "normal" "sam_optim_hyper" "2"
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="sam_optim_rf_k8_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k8" "normal" "sam_optim_hyper" "2"
#
#sbatch --nodes=1 --time=24:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --job-name="sam_optim_rf_k9_cifar10_rs" slurm_run.sh "cifar10" "resnet50" "k9" "normal" "sam_optim_hyper" "2"
