...
sbatch --nodes=1 --time=140:00:00 --partition=small  --mail-type=all --mail-user=sclaam@leeds.ac.uk --error="resnet25_small_lvl_${lvl}_small_imagenet_res_${res}.err" --gres=gpu:1 --output="resnet25_small_lvl_${lvl}_small_imagenet_res_${res}.output"  --job-name="resnet25_small_lvl_${lvl}_small_imagenet_res_${res}" slurm_deep_small_resnet_run.sh "resnet25_small" "small_imagenet" 4 ${lvl}  "normal" 200 "recording_200" 1 1 "${res}"
