# Taken from https://github.com/Lornatang/MobileNetV1-PyTorch/blob/main/model.py
...
class MobileNetV1_RF(nn.Module):

    def __init__(
            self,
            num_classes: int = 1000,
    ) -> None:
        super(MobileNetV1_RF, self).__init__()
...
def mobilenet_v1(**kwargs: Any) -> MobileNetV1_RF:
    model = MobileNetV1_RF(**kwargs)
