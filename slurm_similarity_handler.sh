...
## Level 4  Models
#
#sbatch --nodes=1 --time=30:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl4_s1_V_s2_not_sub_mean.err" --output="comparison_lvl4_s1_V_s2_not_sub_mean.out"  --job-name="comparison_lvl4_s1_V_s2_not_sub_mean" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 4 4 0
...
#sbatch --nodes=1 --time=30:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl6_s1_V_s2_sub_mean.err" --output="comparison_lvl6_s1_V_s2_sub_mean.out"  --job-name="comparison_lvl6_s1_V_s2_sub_mean" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_2" "_seed_3" "normal" "normal" "npy" "npy" "${HOME}/features" 6 6 1
## Level 7  Models
#
#
...
#sbatch --nodes=1 --time=30:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl7_s1_V_s2_sub_mean.err" --output="comparison_lvl7_s1_V_s2_sub_mean.out"  --job-name="comparison_lvl7_s1_V_s2_sub_mean" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_3" "_seed_9" "normal" "normal" "npy" "npy" "${HOME}/features" 7 7 1
#
## Level 8  Models
#
...
#sbatch --nodes=1 --time=30:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl10_s1_V_s2_sub_mean.err" --output="comparison_lvl10_s1_V_s2_sub_mean.out"  --job-name="comparison_lvl10_s1_V_s2_sub_mean" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 10 10 1
