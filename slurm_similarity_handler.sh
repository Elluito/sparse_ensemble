...
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl3_s1_V_s2.err" --output="comparison_lvl3_s1_V_s2.out"  --job-name="comparison_lvl3_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 3 3 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl3_s1_V_s2.err" --output="comparison_lvl3_s1_V_s2.out"  --job-name="comparison_lvl3_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 3 3 1

# Level 4  Models

sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl4_s1_V_s2.err" --output="comparison_lvl4_s1_V_s2.out"  --job-name="comparison_lvl4_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 4 4 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl4_s1_V_s2.err" --output="comparison_lvl4_s1_V_s2.out"  --job-name="comparison_lvl4_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 4 4 1

# Level 5  Models

sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl5_s1_V_s2.err" --output="comparison_lvl5_s1_V_s2.out"  --job-name="comparison_lvl5_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_5" "_seed_8" "normal" "normal" "npy" "npy" "${HOME}/features" 5 5 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl5_s1_V_s2.err" --output="comparison_lvl5_s1_V_s2.out"  --job-name="comparison_lvl5_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_5" "_seed_8" "normal" "normal" "npy" "npy" "${HOME}/features" 5 5 1

# Level 6  Models

sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl6_s1_V_s2.err" --output="comparison_lvl6_s1_V_s2.out"  --job-name="comparison_lvl6_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_2" "_seed_3" "normal" "normal" "npy" "npy" "${HOME}/features" 6 6 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl6_s1_V_s2.err" --output="comparison_lvl6_s1_V_s2.out"  --job-name="comparison_lvl6_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_2" "_seed_3" "normal" "normal" "npy" "npy" "${HOME}/features" 6 6 1

# Level 7  Models


sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl7_s1_V_s2.err" --output="comparison_lvl7_s1_V_s2.out"  --job-name="comparison_lvl7_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_3" "_seed_9" "normal" "normal" "npy" "npy" "${HOME}/features" 7 7 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl7_s1_V_s2.err" --output="comparison_lvl7_s1_V_s2.out"  --job-name="comparison_lvl7_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_3" "_seed_9" "normal" "normal" "npy" "npy" "${HOME}/features" 7 7 1

# Level 8  Models

sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl8_s1_V_s2.err" --output="comparison_lvl8_s1_V_s2.out"  --job-name="comparison_lvl8_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_4" "_seed_5" "normal" "normal" "npy" "npy" "${HOME}/features" 8 8 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl8_s1_V_s2.err" --output="comparison_lvl8_s1_V_s2.out"  --job-name="comparison_lvl8_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_4" "_seed_5" "normal" "normal" "npy" "npy" "${HOME}/features" 8 8 1

# Level 9  Models

sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl9_s1_V_s2.err" --output="comparison_lvl9_s1_V_s2.out"  --job-name="comparison_lvl9_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_5" "_seed_6" "normal" "normal" "npy" "npy" "${HOME}/features" 9 9 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl9_s1_V_s2.err" --output="comparison_lvl9_s1_V_s2.out"  --job-name="comparison_lvl9_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_5" "_seed_6" "normal" "normal" "npy" "npy" "${HOME}/features" 9 9 1


# Level 10  Models

sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl10_s1_V_s2.err" --output="comparison_lvl10_s1_V_s2.out"  --job-name="comparison_lvl10_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 10 10 0
sbatch --nodes=1 --time=12:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="comparison_lvl10_s1_V_s2.err" --output="comparison_lvl10_s1_V_s2.out"  --job-name="comparison_lvl10_s1_V_s2" slurm_similarity_comparison_run.sh "resnet_small" "small_imagenet" "_seed_1" "_seed_2" "normal" "normal" "npy" "npy" "${HOME}/features" 10 10 1
