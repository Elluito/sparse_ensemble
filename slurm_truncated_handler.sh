...
## Level 10  Models
#
sbatch --nodes=1 --time=140:00:00 --partition=small --gres=gpu:1 --mail-type=ALL --mail-user=sclaam@leeds.ac.uk --error="logistic_probes_lvl10_s_1_64.err" --output="logistic_probes_lvl10_s_1_64.out"  --job-name="logistic_probes_lvl10_s_1_64" slurm_truncated_run.sh "resnet_small" "small_imagenet" "${CHECK_1}/resnet_small_normal_small_imagenet_seed.1_rf_level_10_recording_200_ffcv_test_acc_40.4.pth" "seed_1" 10 "normal" "${HOME}/truncated_models_results" 50 "0.001" 1
