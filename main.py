...
def plot_specific_pr_sigma_epsilon_statistics(filepath: str, cfg: omegaconf.DictConfig, specific_sigmas: list,
    ...
    _, valloader, testloader = get_datasets(cfg)
...
def unify_sigma_datasets(sigmas:list,cfg:omegaconf.DictConfig):
    ...
    for sigma in sigmas:
        ...
        global_tem_df = pd.read_csv(f"gradientflow_stochastic_global_{cfg.architecture}_{cfg.dataset}_sigma_{sigma}_pr{cfg.amount}.csv",sep= ",",header=0,index_col=False)
